...
function corsHeaders(extraHeaders = {}) {
  return {
    ...
    'access-control-allow-headers': 'authorization,content-type,x-quota-pulse-secret,x-token-monitor-secret',
    ...extraHeaders
  };
}
...
function requestSecret(req) {
  ...
  return String(req.headers['x-quota-pulse-secret'] || req.headers['x-token-monitor-secret'] || '').trim();
}
