...
(function exposeLimitProviderPresentation(root, factory) {
  const accountIdentityApi = typeof module === 'object' && module.exports
    ...
    : root?.QuotaPulseAccountIdentity;
  const api = factory(accountIdentityApi);
  if (typeof module === 'object' && module.exports) module.exports = api;
  if (root) root.QuotaPulseLimitProviderPresentation = api;
  ...
  // Quota Pulse reports sourceDetail 'managed' and these are NOT live. A remote
