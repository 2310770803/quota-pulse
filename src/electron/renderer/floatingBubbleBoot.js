...
(() => {
  ...
  if (['left', 'right'].includes(side)) {
    ...
    window.__QUOTA_PULSE_INITIAL_FLOATING_BUBBLE__ = { collapsed: true, side };
  }
  ...
  if (Object.keys(viewState).length > 0) window.__QUOTA_PULSE_INITIAL_VIEW_STATE__ = viewState;
  window.__QUOTA_PULSE_SUPPRESS_INITIAL_NUMBER_ANIMATION__ =
